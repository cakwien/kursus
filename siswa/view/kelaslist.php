                  ...
                  <div class="col-md-3">
                     <div class="card shadow-sm">
                        <div class="card-header fw-bold">
                           ...
                           <?php
                           $st1 = '<a title="Masuk kelas" href="?p=timelinekelas&kel='.$lk['id_kelas'].'" class="btn btn-sm btn-primary rounded-pill float-end"><i class="bi-arrow-right-circle"></i></a>';
                           $st2 =
                           '<a title="Kelas Belum Aktif" href="#" class="btn btn-sm btn-secondary rounded-pill float-end"><i class="bi-hourglass-split"></i></a>';
