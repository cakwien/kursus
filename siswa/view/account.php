   ...
   <div class="col-md-9">
      <div class="card">
         <div class="card-header">
            User Data
            <a href="?p=account&edit=true" class="btn btn-sm text-light float-end" style="background-color:navy;"><i class="bi-pencil"></i></a>
         </div>
         <div class="card-body">
            <div class="form-group">
               <label for="nama">Nama </label>
               <input type="text" name="nama" id="" class="form-control" <?= disedit() ?>>
            </div>
            ...
            <div class="form-group mt-2">
               ...
               <div class="row">
                  <div class="col">
                     <input type="text" name="tp_lahir" class="form-control" <?= disedit() ?>>
                  </div>
                  <div class="col">
                     <input type="text" name="tgl_lahir" class="form-control" <?= disedit() ?>>
                  </div>
               </div>
            </div>
            <div class="form-group mt-2">
